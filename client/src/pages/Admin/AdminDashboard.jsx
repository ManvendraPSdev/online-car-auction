    ...
    <div className="min-h-screen bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/70">Manage auctions, users, and monitor system activity</p>
        </div>

        {/* Statistics Cards */}
        {dashboardData && dashboardData.stats && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-sm shadow-sm border border-white/10 p-6">
        ...
        {dashboardData && (
          <div className="mb-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-white">Recent Active Auctions</h2>
              <Link
                to="/auctionlist"
            ...
            {!dashboardData.recentAuctions || dashboardData.recentAuctions.length === 0 ? (
              <div className="text-center py-12 bg-white/5 backdrop-blur-xs border border-white/10 rounded-sm shadow-sm border border-white/10">
                <p className="text-white/70 text-lg">No active auctions at the moment.</p>
              </div>
            ) : (
        ...
        <div>
          ...
          {/* Users Table */}
          <div className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-sm shadow-sm border border-white/10 overflow-hidden">
            <div className="px-6 py-4 border-b border-white/10">
              <h3 className="text-lg font-medium text-white">Latest 10 Users</h3>
            </div>
