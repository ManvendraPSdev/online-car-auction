    ...
    <div className="h-screen w-screen bg-black flex items-center">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-white">
        <div className="max-w-md">
          ...
          <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-white/20 rounded-lg focus:outline-none bg-white/10 hover:bg-white/20">
